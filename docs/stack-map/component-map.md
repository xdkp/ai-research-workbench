...
|---|---|---|---|---|---|
| `offensive-research-portal` | Security workflow system of record | Node, Next.js, Supabase SQL | `pnpm test`, `report-viewer` | offensive-research-portal env/Vercel/Supabase | Scope, tasks, evidence, findings, reports |
...
For security work, `offensive-research-portal` owns final state:
