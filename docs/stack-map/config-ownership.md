...
Hermes may execute approved work and draft candidate material. Fabric may help analyze or write. cc-switch may select the provider/model. Final reportable records stay in `csp-audit`.
